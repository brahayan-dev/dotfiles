...
local function _2_()
  ...
  theme.setup({style = "day", transparent = true, styles = {comments = {italic = true}, floats = "dark", functions = {}, keywords = {italic = true}, sidebars = "dark", variables = {}}, on_colors = _3_, on_highlights = _4_, terminal_colors = true})
